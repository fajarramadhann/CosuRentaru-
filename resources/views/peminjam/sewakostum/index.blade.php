@extends('peminjam.layouts.sewakostum')
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="badge @if ($sewaCostume->status == 'Tersedia') bg-light-success @else bg-light-danger @endif mb-2">{{ $sewaCostume->status }}</span>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <form action="{{ route('sewa-kostum.create') }}" method="GET">
                                        <input type="hidden" name="kostum_id" value="{{ $sewaCostume->id }}">
                                        <button href="{{ route('sewa-kostum.create') }}" class="btn btn-primary @if ($sewaCostume->status == 'Disewa') disabled @endif">Sewa</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
